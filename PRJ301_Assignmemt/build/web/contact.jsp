    ...
    <body>
        ...
        <div class="container-fluid bg-light py-5">
            <div class="col-md-6 m-auto text-center">
                ...
                <p>
                    Contact us anytime!
                    Our team is available 24/7 for inquiries, orders, and support.
                    Reach us via phone, email, or visit our store. We're here to help!
                </p>
            </div>
        </div>
        ...
        <script>
            ...
            L.marker([-23.013104, -43.394365]).addTo(mymap)
                    .bindPopup("Solemate Location").openPopup();
