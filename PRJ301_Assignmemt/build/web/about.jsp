        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>About Us</h1>
                    <p>
                        Solemate offers stylish, 
                        high-quality footwear for every occasion. 
                        With a focus on comfort, fashion, and top-notch service, 
                        we help you find the perfect fit. 
                        Step in and discover your Solemate today!
                    </p>
                </div>
                <div class="col-md-4">
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    Our services include fast delivery, 
                    easy shipping and returns, exciting promotions, 
                    and 24/7 customer support to 
